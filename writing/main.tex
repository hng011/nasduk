...
\begin{document}
    ...
    % Bagian Isi
    % Bab 1 Pendahuluan
    \input{modules/chapter1.tex}

    % Bab 2 Tinjauan Pustaka
    \input{modules/chapter2.tex}

    % Bab 3 Metode Penelitian
    \input{modules/chapter3.tex}

    % Bab 4 Hasil dan Pembahasan
    \input{modules/chapter4.tex}

    % Bab 5 Penutup
    \input{modules/chapter5.tex}
